...
- 🤖 Passionate about **Generative AI, NLP, and Quantitative Analysis**
- 📂 Explore my featured projects:
  - [Interactive CLO Cash Flow Simulator](https://github.com/MrunangG/CLO_Waterfall)
...
![LangChain](https://img.shields.io/badge/-LangChain-0E1117?logo=python&logoColor=white)
...
![RESTful APIs](https://img.shields.io/badge/-REST-02569B?logo=fastapi&logoColor=white)
...
- Developed a quantitative finance model to simulate the cash flow waterfall of a Collateralized Loan Obligation (CLO).
- Features interactive risk analysis of tranche performance (IRR, WAL) against default and recovery rate scenarios.
- Built with Python (Pandas, NumPy) and deployed as an interactive web app using Streamlit.
- [GitHub Repo →](https://github.com/MrunangG/CLO_Waterfall)
